    ...
    try:
        ...
        if 'save-device' in url:
            try:
                ...
                os.system('xdg-open https://www.youtube.com/channel/UCS8E0GfmrARMNv_KU7p5oaA')
                time.sleep(2)
